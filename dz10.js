...
btn.addEventListener("click", exampleFun, false);
icon.innerHTML = icon_01;

function exampleFun(){     
     if(btn.classList.contains('active')){
       icon.innerHTML = icon_01;
     } else{
        icon.innerHTML = icon_02;
     }
...
newButton.addEventListener('click', alerted);
...
function pageLoaded() {
  ...
  //функция,которая пишет текст в чат и добавляет стиль для полученного и отправленного сообщения
